...
const trabalhoRoutes_1 = __importDefault(require("./routes/trabalhoRoutes"));
...
app.use('/api/local', localRoutes_1.default);
app.use('/api/trabalho', trabalhoRoutes_1.default);
